...
print("aqiui si llega")
if __name__ == "__main__":
    print("entro al if")
    parser = argparse.ArgumentParser()
    # bools
    parser.add_argument('--calcmean', help='Train the model', action="store_true")
    parser.add_argument('--traindir', help='Path to train images')
    parser.add_argument('--bgr', help='Path to train images')
    ...
    if args.calcmean:
        ...
        #data.calcmeans(args.traindir)
        print("la ruta desde teclado es", args.traindir)
        ruta=args.traindir
        print("la ruta ", ruta)

        media.calcmeans(args.traindir)

        print("paso la siuyien te  linia")
    ...
    def calcmeans(self, imageFolder , bgr):
