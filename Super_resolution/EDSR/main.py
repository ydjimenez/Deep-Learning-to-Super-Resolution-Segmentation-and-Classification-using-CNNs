...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch', type=int, help='Batch size of the training', default=50)
    ...
    # INIT
    scale = args.scale
    #meanbgr = [103.1545782, 111.561547, 114.35629928] media con el paquete divi 2k
    #meanbgr =[75.57971889,75.57971889,75.57971889]
    meanbgr =[63.98158806,63.98158806,63.98158806]#media con el [paquete de imagenes de mama
