...
if __name__ == '__main__':
    ...
    archivo = open('estadistica/datos.txt', 'w')
    archivo2 = open('estadistica/bestMetrica.txt', 'w')
    ...
    for epoch in range(args.num_epochs):
        ...
        archivo.write('eval_psnr: {:.2f}'.format(epoch_psnr.avg))
    ...
    archivo2.write('best epoch: {}, psnr: {:.2f}'.format(best_epoch, best_psnr))
    archivo.close()
    archivo2.close()
